#!/usr/bin/env python3
"""Translate missing rich_description and viewing_info for all events."""
...
def main():
    ...
    logger.info(f'Events with rich metadata: {len(events)}')
    ...
    # Translate rich descriptions in batches of 3 (smaller for stability)
    batch_size = 3
    if rd_data:
    ...
    # Translate viewing infos in batches of 3
    if vi_data:
